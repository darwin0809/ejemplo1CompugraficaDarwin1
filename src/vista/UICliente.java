...
public class UICliente extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String textoLista = listaClientes.toString();
        jTextArea1.setText(textoLista);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
                ...
                // Código para guardar los datos de los clientes en un archivo .txt
                String rutaArchivo = "C:\\Users\\Darwin Criollo\\OneDrive\\Documentos\\Cliente.txt";
                ...
                try {
                    ...
                    for (Cliente cliente : listaClientes) {
                        ...
                        bufferedWriter.write(cliente.getCodigoCliente() + "," +
                                cliente.getEdadCliente() + "," +
                                cliente.getNombreP() + "," +
                                cliente.getTelefonoP() + "," +
                                cliente.getCorreoP());
                    ...
                    JOptionPane.showMessageDialog(UICliente.this, "Datos de clientes guardados correctamente en el archivo.", "Guardar archivo", JOptionPane.INFORMATION_MESSAGE);
                } catch (IOException ex) {
                    JOptionPane.showMessageDialog(UICliente.this, "Error al guardar los datos en el archivo.", "Error", JOptionPane.ERROR_MESSAGE);
                }
